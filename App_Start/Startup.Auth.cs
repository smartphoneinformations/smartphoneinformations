...
using Owin;
using SmartphoneInformations.Models;
    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
              appId: "1046347722380856",
              appSecret: "e805489ce29dd30e01779246a3929829");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "835537558718-sridkjid7fhjvaq4rq0ktisvqdfu670l.apps.googleusercontent.com",
                ClientSecret = "V8dsJOZPbLsEu36II378IWH_"
            });
        }
    }
}